...
> **版は文書ごとに持ちます。** 利用規約は第1.0版（2026年9月1日）、プライバシーは第1.1版（2026年9月17日）、クレジットは第1.1版（2026年9月4日）です。1文書だけ改訂したときに他の版まで動かさないため、まとめて1つにしません。
> **プライバシーポリシー第7条（対象年齢）と第9条（保有期間）は 2026-09-17 に確定しました（USL-315）。** 法的な適否の確認は 2026-09-02 に責任者が「適切」と報告済みです（USL-255）。[`../asset-and-privacy-inventory.md`](../asset-and-privacy-inventory.md) の「公開前の確認リスト」もあわせて確認してください。
...
1. このMarkdownを直す
2. **その文書の**版と施行日を上げる（利用規約: 第1.0版／2026年9月1日、プライバシー: 第1.1版／2026年9月17日、クレジット: 第1.1版／2026年9月4日）
