> [!WARNING]
> これは旧ワイヤーフレーム方針の履歴資料です。現行仕様として使用しません。現行資料の入口は [`docs/README.md`](../../README.md)、現在のUI実装は [`AppStyle.swift`](../../../apps/ios-swiftui/UsalingoIOS/DesignSystem/AppStyle.swift) と各SwiftUI画面です。デザイン判断の経緯を確認できるよう本文を残しています。
